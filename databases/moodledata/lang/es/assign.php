...
/**
 * Strings for component 'assign', language 'es', version '5.1'.
 *
 * @package     assign
 * @category    string
...
$string['assignmentduedigestsms'] = '{$a->grader} ha añadido retroalimentación a su entrega de la tarea {$a->assignment}: {$a->url}';
...
$string['assignmentduesoonsms'] = 'Su tarea {$a->assignmentname} vence el {$a->duedate}: {$a->url}';
...
Puede verla adjunta a su entrega en
   ...
   {$a->url}';
$string['assignmentmailhtml'] = '<p>{$a->grader} ha hecho un comentario de retroalimentación en su entrega de la tarea "<i>{$a->assignment}</i>".</p>
<p>Puede verla adjunta a su entrega en su <a href="{$a->url}">entrega de tarea</a>.</p>';
...
$string['assignmentoverduesms'] = 'Su tarea {$a->assignmentname} vence el {$a->duedate}: {$a->url}';
...
$string['feedbackavailableanonhtml'] = 'Tiene un nuevo comentario en su entrega para la tarea "{$a->assignment}". Puede verla junto a su <a href="{$a->url}">entrega de la tarea</a>.';
$string['feedbackavailableanonsmall'] = 'Nuevo comentario para la tarea {$a->assignment}';
$string['feedbackavailableanonsms'] = 'Tiene retroalimentación en {$a->assignment}: {$a->url}';
...
Puede verlo junto a su envio de la tarea
    ...
    {$a->url}';
$string['feedbackavailablehtml'] = '{$a->username} ha aportado alguna retroalimentación en su entrega de la tarea "{$a->assignment}.
Puede verla añadida a <a href="{$a->url}">su entrega</a>.';
$string['feedbackavailablesmall'] = '{$a->username} ha hecho un comentario en la tarea {$a->assignment}';
$string['feedbackavailablesms'] = '{$a->username} ha dado retroalimentación en {$a->assignment}: {$a->url}';
...
$string['filtergraded'] = 'Calificado';
...
$string['gradepenalty'] = 'Penalizaciones';
$string['gradepenalty_help'] = 'Si se activa, se aplicarán penalizaciones en las entregas';
$string['gradersubmissionupdatedhtml'] = '{$a->username} ha actualizado la entrega de su tarea "{$a->assignment}" a las {$a->timeupdated}. Está <a href="{$a->url}">disponible en el sitio web</a>.';
$string['gradersubmissionupdatedsmall'] = '{$a->username} ha actualizado su entrega a la tarea  {$a->assignment}.';
$string['gradersubmissionupdatedsms'] = '{$a->username} ha actualizado {$a->assignment}: {$a->url}';
...
$string['overriderecalculatepenalty'] = 'Recalcular penalizaciones para los usuarios';
...
$string['penaltyduedatechangemessage'] = 'Ya se han dado algunas calificaciones. Para cambiar la fecha fin, desactive/active la penalización. Primero debe elegir si recalculará las calificaciones existentes.';
...
$string['submissioncontains'] = 'Su entrega contiene:';
$string['submissioncopiedhtml'] = '<p>Ha realizado una copia de sus envíos previos de la tarea para "{$a->assignment}".</p>
<p>Puede ver el estado de su <a href="{$a->url}">tarea enviada</a>. <p>';
$string['submissioncopiedsmall'] = 'Se han copiado sus envíos previos de la tarea {$a->assignment}';
$string['submissioncopiedsms'] = 'Ha compiado su entrega anterior para  {$a->assignment}: {$a->url}';
$string['submissioncopiedtext'] = 'Ha realizado una copia de sus envíos previos de la tarea "{$a->assignment}"
...
$string['submissionreceiptcontains'] = 'Contenido entregado  ({$a->total} elementos):';
$string['submissionreceipthtml'] = '<p>Se ha enviado su entrega para la tarea "{$a->assignment}".<p>
<p>Puede ver su entrega y comprobar su estado en la <a href="{$a->url}">página de la entrega</a>.<p>
{$a->submissionsummaryhtml}';
$string['submissionreceiptotherhtml'] = 'Su entrega para la tarea "{$a->assignment}" ha sido enviada. Puede comprobar el estado de <a href="{$a->url}">su entrega</a>.';
$string['submissionreceiptothersmall'] = 'Su envío de la tarea {$a->assignment} ha sido entregado.';
$string['submissionreceiptothersms'] = 'Su envío para {$a->assignment} se ha entregado: {$a->url}';
$string['submissionreceiptothertext'] = 'Se ha entregado su envío de la tarea "{$a->assignment}".

Puede comprobar el estado del envío de su entrega:

    {$a->url}';
$string['submissionreceipts'] = 'Enviar recibo de entrega';
$string['submissionreceiptsmall'] = 'Confirmación de entrega de tarea - {$a->assignment}';
$string['submissionreceiptsms'] = 'Ha entregado {$a->assignment}: {$a->url}';
$string['submissionreceipttext'] = 'Ha realizado una entrega en la tarea "{$a->assignment}".
