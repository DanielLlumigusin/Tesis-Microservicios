...
/**
 * Strings for component 'factor_totp', language 'es', version '5.1'.
 *
 * @package     factor_totp
 * @category    string
...
$string['settings:description'] = 'Los usuarios necesitan tener instalada una app de autenticación en sus dispositivos móviles para generar un códgio que deberán introducir durante el acceso.';
$string['settings:shortdescription'] = 'Requerir a los usuarios introducir un código de la app de autenticación de sus dispositivos durante el acceso.';
...
$string['settings:window_help'] = 'La ventana de la contraseña de un solo uso basada en tiempo (TOTP) especifica durante cuándo será válido el código.
    El periodo, que es el tiempo entre códigos generados nuevamente, es 30 segundos.
    Si la ventana es 15 (valor por defecto) y la marca de fecha (timestamp) es 147682209, los intentos de introducir la contraseña de un solo uso (OTP) estarán entre 147682194 (147682209 - 15), 147682209 y 147682224 (147682209 + 15).
    La ventana debe ser menor de 30. Por tanto, esto abarca el OTP anterior pero no el siguiente.
    Puede configurarlo a un valor superior (hasta 29) como solución alternativa si los relojes de los dispositivos de sus usuarios a menudo tienen ligeras desviaciones.';
