...
/**
 * Strings for component 'quiz', language 'es', version '5.1'.
 *
 * @package     quiz
 * @category    string
...
$string['banknotfound'] = 'No se ha encontrado el banco de preguntas. Por favor, busque de nuevo';
...
$string['configintroglobal'] = 'Estos ajustes controlan el comportamiento de las actividades tipo cuestionario para todo el sitio.';
...
$string['currentbank'] = 'Banco actual: {$a}';
...
$string['defaultsettings'] = 'Ajustes de cuestionarios por defecto';
...
$string['eventquizattemptgraded'] = 'Intento de cuestionario calificado';
...
$string['precreateattempts'] = 'Crear intentos previamente';
$string['precreateattempts_desc'] = 'Si se habilita, los cuestionarios tendrán intentos creados antes del momento de apertura del cuestionario, basándose en el "periodo de creación previa" que también debe ajustarse.

Esto evita picos de carga en el servidor cuando los estudiantes comienzan cuestionarios complejos o son muchos a la vez.

No afecta a cuestionarios sin fecha de apertura.

Si el ajuste se bloquea, se fuerza para que esté habilitado o deshabilitado para todos los cuestionarios.
Si se desbloquea, y se configura un "periodo de creación previa", los cuestionarios pueden optar a tener esta característica. Si no se configura el "periodo de creación previa", este ajuste no se mostrará entre los ajustes de configuración del cuestionario.';
$string['precreateattempts_help'] = 'Crear intentos previamente ayuda a optimizar el rendimiento del sitio. Las preguntas no se podrán modificar una vez que el cuestionario tenga intentos.';
$string['precreateoff'] = 'No crear intentos previamente';
$string['precreateperiod'] = 'Periodo de creación previa';
$string['precreateperiod_desc'] = 'El periodo previo al momento de apertura del cuestionario en que se crearán intentos previamente.

Los intentos se generan mediante una tarea programada (mod_quiz\\task\\precreate_attempts) que se ejecuta por defecto una vez a la hora.

Como los cuestionarios no pueden editarse una vez que tienen intentos, es mejor mantener este periodo tan corto como sea posible.
Si pretende tener un cuestionario o una serie de cuestionarios que comiencen a la vez, es razonable poner un periodo corto, como una hora de antelación.
Si tiene varios que comienzan a distintas horas a lo largo del día, y desea que la creación previa suceda cuando el sistema tiene menos carga, como durante la noche, tal vez prefiera configurar un periodo más largo, como de 12 horas, y ajustar la tarea programada para que se ejecute durante horas de menos carga.

Este ajuste se controla a nivel del sitio, y no puede anularse mediante cuestionarios individuales.';
$string['precreatetask'] = 'Crear intentos previamente';
$string['precreateusedefault'] = 'Usar valores del sitio por defecto ({$a})';
$string['precreateyes'] = 'Si, {$a} horas antes del momento de apertura del cuestionario';
...
$string['quizinvalidquestions'] = 'Este cuestionario tiene preguntas con tipos no válidos. Antes de usar el cuestionario, debe reinstalarse el tipo de pregunta no válido o deben eliminarse las preguntas afectadas.';
...
$string['reportusersall'] = 'todos los usuarios que hayan hecho algún intento';
$string['reportuserswith'] = 'usuarios matriculados que hayan hecho algún intento';
$string['reportuserswithorwithout'] = 'usuarios matriculados, hayan hecho intentos o no';
$string['reportuserswithout'] = 'usuarios matriculados que no hayan hecho intentos';
...
$string['selectquestionbank'] = 'Seleccionar banco de preguntas';
...
$string['stateoptions'] = 'Opciones de estado de intentos';
$string['stateoptions_help'] = '* No comenzado: El intento se creó automáticamente antes de la apertura del cuestionario. El estudiante no ha comenzado un intento aún.
* En progreso: El estudiante ha comenzado un intento. Aún tiene tiempo para entregarlo.
* Vencido: El intento ha estado abierto más allá del tiempo límite. El estudiante aún puede entregar el intento dentro del periodo de gracia.
* Entregado: El estudiante ha terminado el intento y ha entregado sus respuestas. Está en cola para evaluación automática.
* Terminado: El intento se ha entregado y se ha evaluado automáticamente.
* Nunca entregado: El estudiante comenzó el intento, pero no lo entregó ni a tiempo ni durante el periodo de gracia.';
$string['stateoverdue'] = 'Atrasados';
$string['stateoverduedetails'] = 'Debe ser presentado por {$a}';
$string['statesubmitted'] = 'Entregado';
