...
/**
 * Strings for component 'role', language 'es', version '5.1'.
 *
 * @package     role
 * @category    string
...
$string['ai:viewaipolicyacceptancereport'] = 'Ver informe de aceptación de política de IA';
$string['ai:viewaiusagereport'] = 'Ver informe de uso de IA';
...
$string['course:viewoverview'] = 'Ver la página de resumen de actividades';
...
$string['reportbuilder:configurecustomfields'] = 'Configurar campos de informe personalizado';
