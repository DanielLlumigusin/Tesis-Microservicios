...
/**
 * Strings for component 'message', language 'es', version '5.1'.
 *
 * @package     message
 * @category    string
...
$string['notsupported'] = 'Sin soporte';
...
$string['successproviderenabled'] = '"{$a->provider}" para "{$a->processor}" actualizado.';
$string['successproviderlocked'] = '"{$a->provider}" para "{$a->processor}" bloqueado.';
$string['successproviderunlocked'] = '"{$a->provider}" para "{$a->processor}" desbloqueado.';
$string['successproviderupdate'] = '"{$a}" actualizado.';
...
$string['unsentmessagenotification'] = 'Usted tiene un mensaje no enviado. Se perderá si sale de esta página.';
