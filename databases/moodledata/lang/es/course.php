...
/**
 * Strings for component 'course', language 'es', version '5.1'.
 *
 * @package     course
 * @category    string
...
$string['overview_info'] = 'Un resumen de todas las actividades de este curso, incluyendo fechas y otra información.';
$string['overview_missing_notice'] = 'Vaya a la {$a}.';
$string['overview_missing_title'] = 'Información {$a} no disponible.';
$string['overview_modname'] = 'Vista previa de {$a}';
$string['overview_page_title'] = 'Actividades de curso: {$a}';
$string['overview_table_caption'] = 'Tabla listando todas las actividades {$a}';
