...
/**
 * Strings for component 'admin', language 'es', version '5.1'.
 *
 * @package     admin
 * @category    string
...
$string['courserequestnotifyemail'] = '<p>El usuario {$a->user} ha solicitado un nuevo curso.</p>
<p>Puede revisar la solicitud en <a href="{$a->link}">{$a->link}</a>.</p>

<p>Detalles de la solicitud:</p>
<ul>
<li>Nombre completo del curso: {$a->fullname}</li>
<li>Nombre corto del curso : {$a->shortname}</li>
<li>Categoría: {$a->category}</li>
<li>Motivo de esta solicitud de curso: {$a->reason}</li>
</ul>';
...
$string['deletedplugintypesdetected'] = 'Se ha detectado un plugin borrado, "{$a}". Esto debería haberse migrado/desinstalado en la ventana de descartes. Ahora este es un tipo de plugin sin soporte y no se puede continuar con la instalación/actualización hasta que se haya desinstalado este plugin.';
...
$string['navfilter'] = 'Filtrar menú personalizado';
$string['navfilter_desc'] = 'Procesa el menú personalizado mediante filtros de Moodle ajustados para aplicarse a <strong>Contenido y Encabezados</strong>. Útil para permitir elementos de menú dinámicos personalizables.';
...
$string['purgecoursecache'] = 'Cursos';
