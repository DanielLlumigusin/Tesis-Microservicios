...
/**
 * Strings for component 'feedback', language 'es', version '5.1'.
 *
 * @package     feedback
 * @category    string
...
$string['append_new_items'] = 'Mantener las preguntas existentes y añadir las nuevas al final';
...
$string['availableforallcourses'] = 'Disponible para todos los cursos';
...
$string['coursetemplates'] = 'Plantillas de curso';
...
$string['delete_old_items'] = 'Sobreescribir preguntas existentes';
...
$string['previewtemplate'] = 'Vista previa de plantilla "{$a}"';
...
$string['save_as_new_template'] = 'Guardar como plantilla';
...
$string['sitetemplates'] = 'Plantillas del sitio';
...
$string['this_feedback_is_already_submitted'] = 'Usted ya ha entregado esta retroalimentación.';
...
$string['whatfor'] = '¿Cómo quiere aplicar la plantilla?';
