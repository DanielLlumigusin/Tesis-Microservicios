...
/**
 * Strings for component 'treasurehunt', language 'es', version '5.1'.
 *
...
$string['availableplayerstyles'] = 'Estilos de pantalla de juego disponibles.';
$string['back'] = 'Atrás';
$string['backtocourse'] = 'Volver al curso';
$string['baselayers'] = 'Capas base';
$string['basemaps'] = 'Mapas base';
$string['bigbutton_play_tour'] = 'Este es tu mejor amigo.<br>Un clic y se te mostrará <b>challenges</b> o valiosos <b>hints</b>.';
...
$string['custommapimageerror'] = 'No se puede cargar la imagen personalizada. Compruebe la configuración de la actividad.';
...
$string['defaultplayerstyle'] = 'Estilo de pantalla de juego predeterminado';
...
$string['nextcamera'] = 'Cambiar de cámara';
$string['nextstep'] = 'Sig.';
...
$string['nomarksmobile'] = 'Primero marque en el mapa el punto deseado.';
...
$string['overlaylayers'] = 'Superposición de capas';
$string['pegmanlabel'] = 'Mira a tu alrededor en StreetView';
$string['play'] = 'Jugar';
$string['playend_tour'] = '¡Disfruta de la Caza del Tesoro con tus compañeros de búsqueda!';
$string['playerclassic'] = 'Clásico';
$string['playerfancy'] = 'Capricho';
$string['playerhelp_tour'] = 'Este tour puede ser revisado cuando quieras.';
$string['playerstyle'] = 'Estilo de pantalla de juego';
$string['playerstyle_help'] = 'Hay varios estilos de pantalla de juego que los profesores pueden elegir';
...
$string['privacy:metadata_treasurehunt_attempts_groupid'] = 'El grupo en el que el usuario jugó la actividad.';
$string['privacy:metadata_treasurehunt_attempts_stageid'] = 'El identificador de fase que el usuario estaba intentando resolver.';
$string['privacy:metadata_treasurehunt_attempts_timecreated'] = 'La hora a la que el usuario realizó un intento.';
$string['privacy:metadata_treasurehunt_attempts_userid'] = 'El identificador del usuario que realizó un intento.';
$string['privacy:metadata_treasurehunt_track'] = 'La búsqueda del tesoro almacena la secuencia de ubicaciones seguidas por un usuario durante la actividad.';
$string['privacy:metadata_treasurehunt_track_location'] = 'La ubicación del usuario en un momento determinado.';
$string['privacy:metadata_treasurehunt_track_timestamp'] = 'La hora a la que se realiza el seguimiento del usuario.';
$string['privacy:metadata_treasurehunt_track_treasurehuntid'] = 'El ID de la búsqueda del tesoro en la que está jugando el usuario.';
$string['privacy:metadata_treasurehunt_track_userid'] = 'El ID del usuario que está siendo rastreado.';
$string['qrreaded'] = 'El código QR se lee:';
...
$string['sendlocationtitle'] = '¿Estás seguro de que quieres enviar esta ubicación?';
$string['showboard'] = 'Mostrar el progreso de otros estudiantes';
$string['showboard_help'] = 'Si se habilita, el progreso de otros estudiantes se mostrará en la página de la actividad.';
