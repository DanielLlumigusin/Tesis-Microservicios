...
/**
 * Strings for component 'badges', language 'es', version '5.1'.
 *
 * @package     badges
 * @category    string
...
$string['badgeimageinfo'] = 'Para obtener los mejores resultados, cargue una imagen cuadrada con un tamaño mínimo de 300x300 píxels.';
...
$string['contact'] = 'Correo electrónico';
...
$string['descriptioninfo'] = '¿Qué representa esta insignia?';
...
$string['fixed'] = 'Fecha fija: Esta insignia expira en la siguiente fecha:';
...
$string['never'] = 'Nunca: Esta insignia no expira.';
...
$string['relative'] = 'Fecha relativa: Esta insignia expira tras un periodo de tiempo:';
