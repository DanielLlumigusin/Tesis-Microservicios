...
/**
 * Strings for component 'error', language 'es', version '5.1'.
 *
 * @package     error
 * @category    string
...
$string['invaliddatetimebetween'] = '{$a->after} debe ser anterior a {$a->before}.';
$string['invaliddatetimemode'] = 'Modo no válido para filtro de fecha y hora:  {$a}';
